...
# DO NOT JUST COPY THE CODE FROM GITHUB, YOU WILL LOSE MAJOR POINTS! You can use it for reference are trying to get the output demostrated in the video. 

https://github.com/bradtraversy/bootstrap-bootcamp-website
## 0 to 14:36 
- Create a new folder under the lecture folder in your pri repo and name it bootstrap.  Inside that folder create an index.html and style.css.  Follow the video to setup the CDN for the css and javascript (JS) and setup the resposnive nav bar. 
